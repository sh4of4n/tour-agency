...
<html lang="en">
    <head>
        ...
        <title>Tour and Travel Agency System - Home Page</title>
    ...
    <body>
        <header>
            <div id="menu-bar" class="fas fa-bars">
                ...
                <i class="fas fa-search" id="search-btn" style="float: right"></i>
                <i class="fas fa-user" id="login-btn" style="float:right; margin-right: 7px"></i>
                </nav>
